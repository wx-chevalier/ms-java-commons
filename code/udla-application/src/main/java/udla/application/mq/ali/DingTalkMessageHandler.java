package udla.application.mq.ali;

import static udla.common.data.mq.MessageQueueName.DING_TALK_SEND_MESSAGE;
...
import udla.common.data.mq.ali.DingTalkMessage;
import udla.infra.service.dingtalk.DingTalkService;
