package udla.application.mq.file;

import static udla.common.data.mq.MessageQueueName.GET_OSS_FILE_INFO_MESSAGE;
...
import udla.common.data.infra.filestore.FileAttributeNames;
import udla.common.data.infra.filestore.FileStoreInfo;
import udla.common.data.infra.filestore.OssFileStoreInfo;
import udla.common.data.mq.file.FileAttributeRetrievalMessage;
import udla.domain.infra.fileformat.StoredFileAttributeService;
import udla.domain.infra.filestore.StoredFile;
import udla.domain.infra.filestore.StoredFileRepository;
import udla.infra.service.aliyun.AliOssService;
