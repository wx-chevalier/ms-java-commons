package udla.application.infra.notice.email;
...
import udla.infra.common.util.RandomUtils;
...
public class EmailServiceImpl implements EmailService {
  ...
  private udla.infra.service.email.EmailService emailService;
  ...
  public EmailServiceImpl(
      @Qualifier("emailService") udla.infra.service.email.EmailService emailService,
