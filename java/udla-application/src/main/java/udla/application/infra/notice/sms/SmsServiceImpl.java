...
import udla.common.data.mq.MessageQueueName;
...
public class SmsServiceImpl implements SmsService {
  ...
  private udla.infra.service.sms.SmsService smsService;
  ...
  public SmsServiceImpl(
      ...
      @Qualifier("smsService") udla.infra.service.sms.SmsService smsService,
