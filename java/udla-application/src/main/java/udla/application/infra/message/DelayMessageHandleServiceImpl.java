...
import static udla.application.mq.message.DelaySendMessageQueueConfig.SEND_MESSAGE_DELAY_EXCHANGE;
import static udla.application.mq.message.DelaySendMessageQueueConfig.SEND_MESSAGE_DELAY_ROUTING_KEY;
...
import udla.application.mq.message.validator.SendMessageValidatorMap;
