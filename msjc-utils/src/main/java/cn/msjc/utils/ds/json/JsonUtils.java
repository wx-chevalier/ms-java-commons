...
public final class JsonUtils {
  ...
  public static final JsonUtils JSON = newJsonTools(new ObjectMapper());

  public static JsonUtils newJsonTools(ObjectMapper mapper) {
    mapper.registerModule(new VavrModule());
    return new JsonUtils(mapper);
  }

  public static JsonUtils newJsonTools(Consumer<ObjectMapper> mapperCustomizer) {
